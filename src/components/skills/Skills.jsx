...
function Skills() {
  ...
  return (
    <section id="skills" className="py-[100px] bg-white font-sans">
      <div className="w-full max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6 mt-12">
          {skills.map((skillGroup, index) => (
            <div className="bg-bg-light p-8 rounded-xl transition-all duration-300 border border-gray-100 hover:-translate-y-1 hover:border-primary-color hover:shadow-[0_8px_30px_rgba(37,99,235,0.08)] group" key={index}>
              <div className="mb-6">
